...
<h1 class="h3 mb-4 text-gray-800">History Request</h1>
          ...
          <form class="user" method="post" action="<?php echo getBaseUrl() ?>api/editRequestSec.php">
            <div class="form-group row">
              <div class="text-center">
                ...
                <a href="<?php echo getBaseUrl() ?>pages/history.php">&larr; Back to history list</a>
              </div>
            </div>
          </form>
        </div>
              ...
              <div class="card shadow mb-5">
                ...
                <div class="card-body">
                    ...
                    <div class="modal-footer">
                      <a href="<?php echo getBaseUrl() ?>pages/history.php" class="btn btn-info"><i class="fas fa-info fa-sm text-white-50"></i> View more history</a>

                      <a target="_blank" href="<?php echo getBaseUrl() ?>pages/printPDF.php?ID=<?php echo $res['reserve_id'] ?>" class="btn btn-primary"><i class="fas fa-print fa-sm text-white-50"></i> Print</a>
                    </div>
