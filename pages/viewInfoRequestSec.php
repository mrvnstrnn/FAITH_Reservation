                ...
                <div class="card-body">
                  <!-- <form class="user" method="post" action="<?php echo getBaseUrl() ?>api/addRequest.php"> -->
                    ...
                    <div class="modal-footer">
                      <button class="btn btn-danger" type="button" data-dismiss="modal" onclick="disapprove('<?php echo $res['ID'] ?>')"><i class="fas fa-times fa-sm text-white-50"></i> Disapprove</button>
                      <button class="btn btn-info" type="button" onclick="approve('<?php echo $res['ID'] ?>')"><i class="fas fa-check fa-sm text-white-50"></i> Approve</button>
                    </div>
