                ...
                <div class="card-body">
                  <form class="user" method="post" action="<?php echo getBaseUrl() ?>api/addRequest.php">
                    ...
                    <div class="modal-footer">
                      <a href="<?php echo getBaseUrl() ?>pages/request.php"><button class="btn btn-info" type="button"><i class="fas fa-info fa-sm text-white-50"></i> View more upcoming events</button></a>
