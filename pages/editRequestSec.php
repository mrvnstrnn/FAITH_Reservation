...
<h1 class="h3 mb-4 text-gray-800">Edit Request</h1>
          ...
          <form class="user" method="post" action="<?php echo getBaseUrl() ?>api/editRequestSec.php">
            <div class="form-group row">
              <div class="text-center">
                ...
                <a href="<?php echo getBaseUrl() ?>pages/requestSec.php">&larr; Back to request list</a>
              </div>
            </div>
          </form>
        </div>
              ...
              <div class="card shadow mb-5">
                ...
                <div class="card-body">
                  <form class="user" method="post" action="<?php echo getBaseUrl() ?>api/editRequestSec.php">
                    <div class="form-group row">
                      <div class="col-lg-4">
                        <input type="hidden" class="form-control form-control" id="id" name="id" aria-describedby="emailHelp" value="<?php echo $_GET['id'] ?>">
                    ...
                    <div class="form-group row">
                      <div class="col-lg-4">
                        <span>Purpose:</span>
                        <input type="text" class="form-control form-control" id="purpose" name="purpose" aria-describedby="emailHelp" value="<?php echo $res['purpose'] ?>">
                      </div>
                      ...
                      <div class="col-lg-4">
                        ...
                        <input type="number" class="form-control form-control" id="noOfParticipant" name="noOfParticipant" aria-describedby="emailHelp" value="<?php echo $res['participant'] ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <div class="col-lg-12">
                        ...
                        <input type="text" class="form-control form-control" id="details" name="details" aria-describedby="emailHelp" value="<?php echo $res['detailRequest'] ?>">
                      </div>
                    ...
                    <?php
                      ...
                      foreach ($dateEvent as $i => $date) { ?>
                        <div class="col-lg-4">
                          ...
                          <input type="text" class="form-control form-control" id="dateNeeded" name="dateNeeded[]" aria-describedby="emailHelp" value="<?php echo $date ?>">
                        </div>

                        <div class="col-lg-3">
                          <span>Start time:</span>
                          <input type="time" class="form-control form-control" id="startTime" name="startTime[]" aria-describedby="emailHelp" value="<?php echo $startTime[$i] ?>">
                        </div>

                        <div class="col-lg-3">
                          <span>End time:</span>
                          <input type="time" class="form-control form-control" id="endTime" name="endTime[]" aria-describedby="emailHelp" value="<?php echo $endTime[$i] ?>">
                        </div>
                      <?php } ?>
                      <div class="col-lg-1">
                        <span>Add</span>
                            ...
                            <div class="table-responsive">
                              <table class="table table-bordered" id="dataTableVenue" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="venueName[]" id="venueName" value="<?php echo $list['nameVenue'] ?>"> <?php echo $list['nameVenue'] ?>
                                    </td>
                                    <td>
                                      <div>
                    ...
                    <div class="modal-footer">
                      <a href="<?php echo getBaseUrl() ?>pages/requestSec.php"><button class="btn btn-danger" type="button"><i class="fas fa-times fa-sm text-white-50"></i> Cancel</button></a>
                      <button class="btn btn-success" type="submit"><i class="fas fa-check fa-sm text-white-50"></i> Update</button>
                    </div>
...
<script type="text/javascript">
  ...
  function addRowTime(){
    ...
    $('#dateTime').find('tbody').append($(
      '<div class="form-group row">' +
        '<div class="col-lg-4">' +
          '<input type="date" class="form-control form-control" id="dateNeeded" name="dateNeeded[]" aria-describedby="emailHelp" required="" oninvalid="this.setCustomValidity("Please enter date")" oninput="setCustomValidity("")">' +
        '</div>' +
              
        '<div class="col-lg-3">' +
          '<input type="time" class="form-control form-control" id="startTime" name="startTime[]" aria-describedby="emailHelp" required="" oninvalid="this.setCustomValidity("Please enter start time")" oninput="setCustomValidity("")">' +
        '</div>' +
              
        '<div class="col-lg-3">' +
          '<input type="time" class="form-control form-control" id="endTime" name="endTime[]" aria-describedby="emailHelp" required="" oninvalid="this.setCustomValidity("Please enter end time")" oninput="setCustomValidity("")">' +
        '</div>'+
