...
<h1 class="h3 mb-4 text-gray-800">View Pending Request</h1>
              ...
              <div class="card shadow mb-5">
                ...
                <div class="card-body">
                    ...
                    <div class="modal-footer">
                      <a href="<?php echo getBaseUrl() ?>pages/requestDean.php" class="btn btn-info"><i class="fas fa-info fa-sm text-white-50"></i> View more pending request</a>
                    </div>
