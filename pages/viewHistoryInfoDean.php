          ...
          <form class="user" method="post" action="<?php echo getBaseUrl() ?>api/editRequestSec.php">
            <div class="form-group row">
              <div class="text-center">
                ...
                <a href="<?php echo getBaseUrl() ?>pages/historyDean.php">&larr; Back to history list</a>
              </div>
            </div>
          </form>
        </div>
              ...
              <div class="card shadow mb-5">
                ...
                <div class="card-body">
                    ...
                    <div class="modal-footer">
                      <a href="<?php echo getBaseUrl() ?>pages/historyDean.php" class="btn btn-info"><i class="fas fa-info fa-sm text-white-50"></i> View more history</a>
                    </div>
