                  ...
                  <form class="user" method="post" action="<?php echo getBaseUrl() ?>api/addRequest.php">
                    <div class="form-group row">
                      <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control form-control" id="employeeNo" name="employeeNo" aria-describedby="emailHelp" placeholder="Employee Number" required="" oninvalid="this.setCustomValidity('Please enter employee number')" oninput="setCustomValidity('')" onChange="requestDetails()">
                        <span style="color: red;">
                          <?php echo (isset($_SESSION['errors']['msgNotEmployee']) ? $_SESSION['errors']['msgNotEmployee'] : "")?><?php unset($_SESSION['errors']['msgNotEmployee']) ?>
                        </span>
                      </div>

                      <div class="col-lg-4">
                        <span>Firstname:</span> <b><span style="color: red">*</span></b>
                        <input type="text" class="form-control form-control" id="fnames" name="fnames" aria-describedby="emailHelp" placeholder="Firstname" required="" oninvalid="this.setCustomValidity('Please enter firstname')" oninput="setCustomValidity('')" disabled>
                      </div>

                      <div class="col-lg-4">
                        <span>Lastname:</span> <b><span style="color: red">*</span></b>
                        <input type="text" class="form-control form-control" id="lnames" name="lnames" aria-describedby="emailHelp" placeholder="Lastname"  required="" oninvalid="this.setCustomValidity('Please enter lastname')" oninput="setCustomValidity('')" disabled>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control form-control" id="departments" name="departments" aria-describedby="emailHelp" placeholder="Department"  required="" oninvalid="this.setCustomValidity('Please enter lastname')" oninput="setCustomValidity('')" disabled>
                      </div>
                    ...
                    <div class="form-group row">
                      <div class="col-lg-12">
                        <span>Details of Request(s):</span> <b><span style="color: red">*</span></b>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control form-control" id="dateNeeded" name="dateNeeded[]" aria-describedby="emailHelp" placeholder="Date needed" required="" oninvalid="this.setCustomValidity('Please enter date')" oninput="setCustomValidity('')">
                        <span style="color: red;">
                    ...
                    <div class="form-group row">
                      <div class="col-lg-6">
                        <div class="card shadow mb-4">
                          <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Venue List <b><span style="color: red">*</span></b>
                          ...
                          <div class="card-body">
                            <div class="table-responsive">
                              <table class="table table-bordered" id="dataTableEquip" width="100%" cellspacing="0">
                                ...
                                <tr>
                                  <td>
                                    <input type="checkbox" name="equipName[]" value="<?php echo $listEquip['equipmentName'] ?>"> <?php echo $listEquip['equipmentName'] ?>
                                  </td>
                                  <td>
                                    <?php if($listEquip['capacity'] < 0){ ?>
                                      <span style="color: red">Need to rent <?php echo number_format(-($listEquip['capacity'])); ?></span>
                                    <?php } else {
                                  ...
                                  <td>
                                    <div>
                                      <input class="form-control" type="number" name="capacityEquip[]">
                                    </div>
                                  </td>
                                </tr>
                                <?php } ?>
...
<script type="text/javascript">
  function requestDetails () {
    ...
    if (employeeNo.length > 5) {
      $.post("../api/getEmployeeInfo.php", {employeeNo: employeeNo}, function (o) {
        $("#fname").val(o.firstName),
        $("#lname").val(o.lastName),
        $("#department").val(o.department),
        $("#fnames").val(o.firstName),
        $("#lnames").val(o.lastName),
        $("#departments").val(o.department)
      }, 'json')
    }
  }
...
$("#endTime").val(curr_time);
  ...
  //     return ((d.getDate()).toString().length == 1) ? "0"+(d.getDate()).toString() : (d.getDate()+1).toString();
  //   };
  ...
  //   document.getElementById('dateNeeded').setAttribute("value", today_ISO_date);
  //      // alert(today_ISO_date);
  //    var dd_mm_yyyy;
