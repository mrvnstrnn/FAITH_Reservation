          ...
          <form class="user" method="post" action="<?php echo getBaseUrl() ?>api/editRequestSec.php">
            <div class="form-group row">
              <div class="text-center">
                ...
                <a href="<?php echo getBaseUrl() ?>pages/requestDean.php">&larr; Back to request list</a>
              </div>
            </div>
          </form>
        </div>
                ...
                <div class="card-body">
                  <!-- <form class="user" method="post" action="<?php echo getBaseUrl() ?>api/addRequest.php"> -->
                    ...
                    <div class="modal-footer">
                      <a href="<?php echo getBaseUrl() ?>pages/editRequestSec.php?id=<?php echo $res['ID'] ?>"><button class="btn btn-primary"><i class="fas fa-pen text-white-50"></i> Edit</button></a>
                      <a href="<?php echo getBaseUrl() ?>pages/requestSec.php"><button class="btn btn-info" type="button"><i class="fas fa-info fa-sm text-white-50"></i> View more request</button></a>
                    </div>
