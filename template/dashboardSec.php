      ...
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Manage Request</div>
          ...
          <a href="requestSec.php" class="btn btn-primary">View Details</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          ...
          <a href="historySecretary.php" class="btn btn-success">View Details</a>
        </div>
      </div>
    </div>
